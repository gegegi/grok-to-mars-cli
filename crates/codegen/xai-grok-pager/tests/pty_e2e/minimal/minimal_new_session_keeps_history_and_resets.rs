...
/// The robust "new session" signal is then a *second* welcome card (two `Grok To Mars` banners across scrollback and screen).
...
async fn minimal_new_session_keeps_history_and_resets() {
    ...
    const WELCOME_BANNER: &str = "Grok To Mars";
